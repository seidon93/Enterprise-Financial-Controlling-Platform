"""
One-time fix: Drop and recreate fact_gl table with correct identity column.
The original DDL had a missing comma that broke the GENERATED ALWAYS AS IDENTITY.
"""
...
def main() -> None:
    print("Dropping and recreating warehouse.fact_gl...")

    with db.cursor() as cursor:
        cursor.execute(DDL)

    print("Done! fact_gl table recreated with correct identity column.")
