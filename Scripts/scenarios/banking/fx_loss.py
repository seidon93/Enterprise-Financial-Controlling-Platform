...
-------------------------------------------------------------------------------
Object          : fx_loss.py
Object Type     : Foreign Exchange Loss Scenario
Layer           : ETL
Version         : 1.0.0
Status          : Development
-------------------------------------------------------------------------------
Description:
Generates accounting entries for foreign exchange losses.
===============================================================================
"""
...
class FXLossScenario(AccountingScenario):
    """
    Generates accounting entries for FX loss.
    """
    ...
    def create(
        ...
        entry.add_line(
            JournalLine(
                line_number=1,
                account_number=BankAccounts.FX_LOSS,
