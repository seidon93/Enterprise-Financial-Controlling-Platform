...
-------------------------------------------------------------------------------
Object          : deferred_revenue.py
Object Type     : Deferred Revenue Scenario
Layer           : ETL
Version         : 1.0.0
Status          : Development
-------------------------------------------------------------------------------
Description:
Generates accounting entries for deferred revenue.
===============================================================================
"""
...
class DeferredRevenueRequest:
    """
    Input data for deferred revenue.
    """
...
class DeferredRevenueScenario(AccountingScenario):
    """
    Generates accounting entries for deferred revenue.
    """
    ...
    def create(
        ...
        entry.add_line(
            JournalLine(
                line_number=2,
                account_number=ClosingAccounts.DEFERRED_REVENUE,
                company_code=request.company_code,
                cost_center_code=request.cost_center_code,
                department_code=request.department_code,
                currency_code=request.currency_code,
