...
-------------------------------------------------------------------------------
Object          : provision.py
Object Type     : Provision Scenario
Layer           : ETL
Version         : 1.0.0
Status          : Development
-------------------------------------------------------------------------------
Description:
Generates accounting entries for provisions.
===============================================================================
"""
...
class ProvisionScenario(AccountingScenario):
    """
    Generates accounting entries for provisions.
    """
    ...
    def create(
        ...
        entry.add_line(
            JournalLine(
                line_number=2,
                account_number=request.provision_account,
                company_code=request.company_code,
                cost_center_code=request.cost_center_code,
                department_code=request.department_code,
                currency_code=request.currency_code,
