...
-------------------------------------------------------------------------------
Description:
Unit tests for ScenarioRouter - Sales Invoice routing.
===============================================================================
"""
...
def test_sales_invoice_is_routed():
    ...
    router.sales_scenario.create.assert_called_once()